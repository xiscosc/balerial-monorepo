export enum ButtonStyle {
	WHATSAPP = 'bg-green-800 hover:bg-green-900 focus:ring-green-900 border',
	...
	DELETE = 'bg-red-700 hover:bg-red-800 focus:ring-red-800 border border-red-900',
	DELETE_VARIANT = 'bg-red-100 text-red-700 hover:bg-red-200 focus:bg-red-200 border border-red-700',
	SOFT_DELETE = 'bg-gray-300 hover:bg-gray-400 focus:ring-gray-400 border border-gray-900',
	...
	ORDER_PICKED_UP = 'bg-green-700 hover:bg-green-800 focus:ring-green-500 border border-green-900',
...
export enum ButtonType {
	DEFAULT = 'rounded-md px-4 py-2 text-center focus:ring-offset-2 focus:ring-gray-900 focus:ring-2',
	SMALL = 'rounded-md px-2 py-1 text-center focus:outline-hidden focus:ring-offset-2 focus:ring-gray-900 focus:ring-2',
	HOME = 'w-full rounded-md px-6 py-4 text-left text-lg font-semibold focus:ring-offset-2 focus:ring-gray-900 focus:ring-2'
}
